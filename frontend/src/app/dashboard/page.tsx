  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-200 p-6 space-y-6">
      ...
      <header className="flex justify-between items-center">
        <h1 className="text-2xl font-bold">📊 Dashboard - Comissão Pro</h1>
        <div className="flex gap-3 items-center">
          <button onClick={handleLogout} className="px-4 py-2 rounded bg-red-600 hover:bg-red-700 text-white">Sair</button>
        </div>
      </header>
